...
{
    [Activity(Label = "سنن أبي داود", Icon = "@drawable/Mohamed", Theme = "@android:style/Theme.Holo.Light")]
    public class SonanAbyDawod : Activity
    {
