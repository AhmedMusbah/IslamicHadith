...
{
    [Activity(Label = "صحيح البخاري", Icon = "@drawable/Mohamed", Theme = "@android:style/Theme.Holo.Light")]
    public class SahihElBokhary : Activity
    {
